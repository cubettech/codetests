...
(function ($, document) {
    $.glisse = function (element, options) {
        ...
        var createElements = function createElements() {
            ...
            plugin.els['controlNext']   = $(document.createElement('i')).attr('class','glisse-next').addClass('arrows ai-arrow-down i2')
            ...
            plugin.els['controlPrev']   = $(document.createElement('i')).attr('class','glisse-prev').addClass('arrows ai-arrow-down i2')
                                            .append($(document.createElement('a')).html('&#60;').attr("href", "#"));
